...
$(function () {
    ...
    $('#slickQuiz2').slickQuiz({json: {"info": {
        "name":    "Интеллектуальный тест2",
        "main":    "<p>Думаешь ты самый крутой решатель в этом городе? Что ж, посмотрим как ты справишься с продолжением легендарного теста!</p>",
        "results": "<p>Этот тест был под силу не каждому. Ты молодец, приходи еще.</p>"
    },
    "questions": [
        { // Question 1 - Multiple Choice, Single True Answer
